...
from .views import (
    # Auth
    RegisterView, CustomLoginView, check_username, check_email,
    verify_user_phone, set_new_password_and_security,
    get_security_question, reset_password_with_security_answer, 

    # Dashboard Views
    BuyerDashboardView, ArtisanDashboardView, AdminDashboardView,

    # Products
    ProductListView, ProductDetailView,
    ArtisanCreateProductView, ArtisanProductListView, ArtisanProductDetailView,
    toggle_product_status,

    # Orders
    BuyerPlaceOrderView, BuyerOrderHistoryView,
    ArtisanOrderListView, update_order_status, update_delivery_status,
    ...
    # Analytics
    artisan_dashboard_analytics, admin_dashboard_analytics,

    # Wishlist
    WishlistView, WishlistDeleteView,

    # Cart
    CartListCreateView, CartItemUpdateDeleteView, buy_now_order,

    # Profile
    update_profile, update_password, get_profile,

    # Address (Buyer only)
    add_address, get_addresses, delete_address
)
