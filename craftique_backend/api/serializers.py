...
class RegisterSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ('username', 'full_name', 'email', 'phone', 'password', 'is_buyer', 'is_artisan')
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ('buyer', 'status', 'created_at', 'delivery_status', 'delivery_date')
...
class UserAdminSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ['id', 'username', 'full_name', 'email', 'phone', 'is_buyer', 'is_artisan', 'is_admin', 'is_active', 'date_joined']
...
class AdminProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ['id', 'title', 'description', 'category', 'price', 'stock', 'artisan_name', 'image', 'created_at']
